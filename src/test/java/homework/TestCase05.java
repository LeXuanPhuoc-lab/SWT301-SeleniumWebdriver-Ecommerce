...
public class TestCase05 {
    ...
    public void TestCase05(){
        ...
        try{
            // default info
            String firstName = "Le Xuan";
            String lastName = "Phuoc";
            String email = "test1123@gmail.com";
            String password = "@Lexuanphuoc2";
            String confirmPass = "@Lexuanphuoc2";
            ...
            System.out.println("Expected message: " + "WELCOME, LE XUAN PHUOC!");
            System.out.println("Actual message: " + msg.getText());
            AssertJUnit.assertEquals(msg.getText(), "WELCOME, LE XUAN PHUOC!");
            // stop 1s
            Thread.sleep(1000);
            //6. Go to TV menu
            ...
            // sleep 1s
            Thread.sleep(1000);
            driver.findElement(By.xpath("//textarea[@id='message']")).sendKeys("Hello, i'm Phuoc");
            // sleep 1s
            Thread.sleep(1000);
            //10.Check wishlist is shared. Expected wishlist shared successfully.
            driver.findElement(By.xpath("//span[contains(text(),'Share Wishlist')]")).click();
            ...
            String png = ("D:\\selenium-webdriver-java\\src\\test\\java\\homework\\TestCase05.png");
